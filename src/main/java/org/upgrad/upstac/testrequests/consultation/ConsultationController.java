...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor() {
        ...
        // replace this line of code with your implementation
        User doctor = userLoggedInService.getLoggedInUser(); // Get logged in User object
        return testRequestQueryService.findByDoctor(doctor); // Return the list of TestRequest objects
    }
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            // replace this line of code with your implementation
            User doctor = userLoggedInService.getLoggedInUser(); // Get logged in User object
            return testRequestUpdateService.assignForConsultation(id, doctor); // Return TestRequest object
    ...
    public TestRequest updateConsultation(@PathVariable Long id, @RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            // replace this line of code with your implementation
            User doctor = userLoggedInService.getLoggedInUser(); // Get logged in User object
            return testRequestUpdateService.updateConsultation(id, testResult, doctor); // Return TestRequest object
