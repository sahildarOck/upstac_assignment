...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester() {
        ...
        User tester = userLoggedInService.getLoggedInUser(); // Get logged in User object
        return testRequestQueryService.findByTester(tester); // Return List of TestRequest objects
    }
